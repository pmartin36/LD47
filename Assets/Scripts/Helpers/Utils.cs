...
public abstract class Colors {
	public static Color Black => new Color(0.06f, 0.06f, 0.06f);
	public static Color Cream => new Color(1f, 0.98f, 0.91f);
	public static Color DarkCream => Cream * 0.78f;
	public static Color DarkerCream => Cream * 0.5f;
...
public static class Ext {
	public static Direction GetDirectionValue(this DirectionEnum d) {
		switch (d) {
